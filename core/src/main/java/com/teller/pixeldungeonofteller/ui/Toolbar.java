...
public class Toolbar extends Component {
    ...
    protected void layout() {
        ...
        int slots = PixelDungeonOfTeller.quickSlots();
        ...
        for (int i = 0; i <= 3; i++) {
            ...
            if (slots == 4 && width < 152) {
                if (width < 138) {
                    if ((PixelDungeonOfTeller.flipToolbar() && i == 3) ||
                            (!PixelDungeonOfTeller.flipToolbar() && i == 0)) {
                    ...
                    if (i == 0 && !PixelDungeonOfTeller.flipToolbar() ||
                            i == 3 && PixelDungeonOfTeller.flipToolbar()) {
                        btnQuick[i].border(0, 2);
                        btnQuick[i].frame(106, 0, 19, 24);
                    } else if (i == 0 && PixelDungeonOfTeller.flipToolbar() ||
                            i == 3 && !PixelDungeonOfTeller.flipToolbar()) {
        ...
        float right = width;
        switch (Mode.valueOf(PixelDungeonOfTeller.toolbarMode())) {
            case SPLIT:
                btnWait.setPos(x, y);
        ...
        if (PixelDungeonOfTeller.flipToolbar()) {
