...
public class Assets {
    ...
    public static final String HUNTRESS = HEROS + "ranger.png";
    ...
    public static final String WALL_BLOCKING = LEVELS + "wall_blocking.png";
    ...
    public static final String ICONS = MISCS + "icons.png";
    ...
    public static final String MP_BAR = MISCS + "mp_bar.png";

    public static final String ARMOR_BAR = MISCS + "armor_bar.png";
    ...
    public static final String FIREBALL = MISCS + "fireball.png";
    ...
    public static final String CONS_ICONS = MISCS + "consumable_icons.png";
    public static final String PIXELFONT = MISCS + "pixel_font.png";
    public static final String FONT1X = MISCS + "font1x.png";
    public static final String FONT2X = MISCS + "font2x.png";

    public static final String MAGICMISSLE = SPELLS + "magicmissle.png";
    public static final String LIGHTUP = SPELLS + "lightup.png";

    public static final String FIREBALLSPELL = SPELLS + "fireball.png";

    public static final String FLASH = SPELLS + "flash.png";
