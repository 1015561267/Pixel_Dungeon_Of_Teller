...
import com.teller.pixeldungeonofteller.effects.BannerSprites.Type;
...
import com.teller.pixeldungeonofteller.windows.WndClass;
...
public class StartScene extends PixelScene {
    ...
    public void create() {
        ...
        int slotGap = PixelDungeonOfTeller.landscape() ? 5 : 10;
        ...
        if (PixelDungeonOfTeller.landscape()) yPos += 8;
