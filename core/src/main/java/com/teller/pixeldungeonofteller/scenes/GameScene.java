...
public class GameScene extends PixelScene {
    ...
    public static void layoutTags() {
        ...
        float tagLeft = PixelDungeonOfTeller.flipTags() ? 0 : uiCamera.width - scene.attack.width();

        if (PixelDungeonOfTeller.flipTags()) {
    ...
    public void create() {
        ...
        PixelDungeonOfTeller.lastClass(Dungeon.hero.heroClass.ordinal());

        super.create();
        Camera.main.zoom(GameMath.gate(minZoom, defaultZoom + PixelDungeonOfTeller.zoom(), maxZoom));
