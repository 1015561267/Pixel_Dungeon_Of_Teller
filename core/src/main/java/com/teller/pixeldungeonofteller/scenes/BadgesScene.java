...
public class BadgesScene extends PixelScene {
    ...
    public void create() {
        ...
        float pw = Math.min(w, (PixelDungeonOfTeller.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3) - 16;
        float ph = Math.min(h, (PixelDungeonOfTeller.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3) - 32;
