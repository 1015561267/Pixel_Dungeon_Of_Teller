...
public class WndLangs extends Window {
    ...
    public WndLangs() {
        ...
        for (int i = 0; i < langs.size(); i++) {
            ...
            RedButton btn = new RedButton(Messages.titleCase(langs.get(i).nativeName())) {
                ...
                protected void onClick() {
                    ...
                    PixelDungeonOfTeller.switchNoFade(TitleScene.class, new Game.SceneChangeCallback() {
                        @Override
                        public void beforeCreate() {
                            PixelDungeonOfTeller.language(langs.get(langIndex));
            ...
            if (PixelDungeonOfTeller.landscape() && i % 2 == 1) {
        ...
        resize(PixelDungeonOfTeller.landscape() ? WIDTH_L : WIDTH_P, y);
